...
const seo = {
  ...
  og: {
    title: "Rahul Dandu",
    type: "website",
    url: "https://github.com/dandurahul",
  },
};
...
const greeting = {
  ...
  subTitle:
    "A passionate individual who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact.",
  resumeLink:"https://drive.google.com/file/d/1VvIylY4Dm6trhNwGhxQzSC81khVTQmE-/view?usp=sharing",
  portfolio_repository: "https://github.com/dandurahul",
  githubProfile: "https://github.com/dandurahul",
};
...
const socialMediaLinks = [
  ...
  {
    name: "Github",
    link: "https://github.com/dandurahul",
  ...
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/rahul-dandu-8645a2247/",
  ...
  {
    name: "Twitter",
    link: "https://twitter.com/rahuldandu08",
    fontAwesomeIcon: "newtwitter.png", // Reference https://fontawesome.com/icons/twitter?style=brands
    backgroundColor: "#000000", 
  // Reference https://simpleicons.org/?q=twitter
    active: true,
  },
  // {
  //   name: "NPM",
...
const degrees = {
  degree: [
    {
      title: "Loyol Degree College YSRR in Pulivendula",
      subtitle: "Bachelor of Computer Applications",
      logo_path: "logocollege.jpeg",
      alt_name: "YVU University",
      duration: "2023 - Present",
      descriptions: [
        "⚡ Pursuing Bachelor of Computer Applications, from 2023.",
        "⚡ Ms Office;  c Programming; Java;  Sql;  Html,css;  Python; R Language ",
        "⚡ Effective communication; Collaboration; Adaptability; critical and innovative mindset.",
      ],
      website_link: "https://loyoladegreecollegeysrr.ac.in/",
    },
    // {
    //   title: "Masai School",
...
const projectsHeader = {
  title: "Projects",
  description:
    "I create front-end Projects, deploying them as web apps with cloud tech. Prioritizing security and performance, I emphasize documentation, testing, and automation. Feedback-driven and organized, I'm dedicated to continuous learning for project excellence. ❣️",
  ...
  data: [
    {
      ...
      createdAt: "2023-03",
      url: "https://githwwub.com/alaniranjan",
      description: [
        "⚡It basic eecommerce resource for setting up your custum React application ",
        "⚡It provides step-by-step guidance on configuring your React project and installing the necessary dependencies.",
        "⚡React Webpack Starter utilizes technologies such as React, scss. For a comprehensive view, we recommend checking out our GitHub repository ",
      ],
      isFork: false,  
      link: "https://e-commewwwwrce-web-wj1m.onrender.com",
      languages: [
        {
          name: "React.js",
    ...
    },
    {
      ...
      name: "Foodie Blog",
      createdAt: "2023-03",
      url: "https://githusb.com/alaniranjanss",
      description: [
      ...
      isFork: false,
      link: "https://foodie-blog-starter.onrewnder.comsss/",
      languages: [
        {
          name: "HTML",
...
const contactPageData = {
  ...
  blogSection: {
    ...
    link: "https://medium.com/me/settings/account",
    avatar_image_path: "blog.png",
  },
  addressSection: {
    title: "Address",
    subtitle: "I'm originally from Mydukur, but I currently lives in Bangalore.",
    avatar_image_path: "address.png",
    // location_map_link: "https://www.google.com/maps/@28.5006897,77.3152116,12z",
  },
  phoneSection: {
    name: "Phone Number",
    number: "+91 7569952883",
  },
};
